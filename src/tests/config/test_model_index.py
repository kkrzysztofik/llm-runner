...
def test_refresh_scans_directory(
    ...
    with patch("llama_manager.model_index._extract_model_index_metadata") as mock_extract:
        from llama_manager.metadata import GGUFMetadataRecord
...
def test_refresh_reports_progress(
    ...
    with patch("llama_manager.model_index._extract_model_index_metadata", return_value=record):
...
def test_refresh_progressive_writes_partial_cache(
    ...
    with (
        patch("llama_manager.model_index._extract_model_index_metadata", return_value=record),
