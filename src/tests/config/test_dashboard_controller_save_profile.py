"""Tests for DashboardController.save_slot_profile_from_form."""
...
from llama_manager.dashboard_controller import DashboardController, SlotProfilePayload


def _make_payload(**overrides: object) -> SlotProfilePayload:
    """Build a valid SlotProfilePayload with optional overrides."""
...
@pytest.fixture()
def valid_payload() -> SlotProfilePayload:
...
def clean_xdg_config(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    """Ensure no existing slot_profiles.toml interferes with tests."""
    monkeypatch.setenv("XDG_CONFIG_HOME", str(tmp_path))
    return tmp_path


@pytest.fixture()
def mock_save_custom_slot_profile() -> Generator[MagicMock]:
    """Mock save_custom_slot_profile at its source module.

    The DashboardController.save_slot_profile_from_form method does a local import:
    ...
    with patch(
        "llama_manager.slot_profile_store.save_custom_slot_profile",
        mock,
    ):
        yield mock
...
def test_save_valid_profile(
    ...
    valid_payload: SlotProfilePayload,
    mock_save_custom_slot_profile: MagicMock,
    clean_xdg_config: Path,
) -> None:
    """save_slot_profile_from_form should return True for valid payload."""
    result = controller.save_slot_profile_from_form(valid_payload)
...
def test_save_valid_profile_calls_save(
    ...
    """save_slot_profile_from_form should call save_custom_slot_profile."""
    controller.save_slot_profile_from_form(valid_payload)
    mock_save_custom_slot_profile.assert_called_once()
...
def test_save_empty_profile_id(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for empty profile_id."""
...
def test_save_whitespace_profile_id(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for whitespace-only profile_id."""
    payload = _make_payload(profile_id="   ", label="Label")
    result = controller.save_slot_profile_from_form(payload)
    assert result is False
...
def test_profile_id_normalized(controller: DashboardController) -> None:
    ...
    with patch(
        ...
        controller.save_slot_profile_from_form(payload)
...
def test_save_invalid_port_too_low(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for port < 1024."""
...
def test_save_invalid_port_zero(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for port == 0."""
...
def test_save_invalid_port_too_high(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for port > 65535."""
...
def test_save_port_at_boundary(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept port == 1024."""
...
def test_save_port_at_max(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept port == 65535."""
...
def test_save_nonpositive_ctx_size(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for ctx_size <= 0."""
...
def test_save_nonpositive_ctx_size_negative(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for negative ctx_size."""
...
def test_save_nonpositive_ubatch_size(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for ubatch_size <= 0."""
...
def test_save_nonpositive_threads(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for threads <= 0."""
...
def test_save_ngpu_layers_all(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept n_gpu_layers == 'all'."""
...
def test_save_ngpu_layers_negative(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for negative n_gpu_layers."""
...
def test_save_ngpu_layers_zero(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept n_gpu_layers == 0."""
...
def test_save_ngpu_layers_string_invalid(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for invalid n_gpu_layers string."""
...
def test_save_invalid_json_chat_template(controller: DashboardController) -> None:
    """save_slot_profile_from_form should return False for invalid JSON chat_template_kwargs."""
...
def test_save_valid_json_chat_template(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept valid JSON chat_template_kwargs."""
...
def test_save_dict_chat_template(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept dict chat_template_kwargs."""
...
def test_save_empty_chat_template(controller: DashboardController) -> None:
    """save_slot_profile_from_form should accept empty chat_template_kwargs."""
...
def test_save_duplicate_profile_returns_false(
    ...
    """save_slot_profile_from_form should return False when store raises ValueError."""
    with patch(
        "llama_manager.slot_profile_store.save_custom_slot_profile",
